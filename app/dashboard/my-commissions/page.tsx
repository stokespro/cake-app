...
interface FilterState {
  /** Shared list-date preset; 'custom' reads customFrom/customTo. */
...
export default function MyCommissionsPage() {
  ...
  const filterCommissions = useCallback(() => {
    ...
    // Filter by commission (order) date, using the selected preset — or the
    // custom from/to dates when the preset is 'custom'. 'all' resolves to an
    // unbounded range, which leaves every commission in.
